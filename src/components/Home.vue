<template>
  <v-container>
   ...
   <v-layout>
    <v-flex xs6 >
      <v-card class="grey grey darken-1 white--text">
        ...
        <v-card-title primary-title>
          <div>
            ...
            <div>Loocads is looking for investors</div>
            </br>
          ...
          <div>
              <v-btn color="primary">Contact Us</v-btn>
            </div>
        </v-card-title>
      </v-card>
    </v-flex>
    ...
    <v-flex xs6 >
         ...
         <h3 class="headline mb-0 text-xs-center">Client Login</h3>
        ...
        <form @submit.prevent="onSignin">
                ...
                <v-layout row>
                  <v-flex xs12>
                    <v-btn type="submit" :disabled="loading" :loading="loading" center>
                      Sign in
